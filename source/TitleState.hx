...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
        ...
        switch (FlxG.random.int(1, 2))
	       {
		case 1: logoBl = new FlxSprite(titleJSON.titlex, titleJSON.titley);
		        logoBl.frames = Paths.getSparrowAtlas('fnf_element_logo');
		logoBl.antialiasing = ClientPrefs.globalAntialiasing;
		logoBl.animation.addByPrefix('bump', 'fnf_element_bumbingEdit', 27, false);
		logoBl.animation.play('bump');
		logoBl.updateHitbox();

		case 2: logoBl = new FlxSprite(titleJSON.titlex, titleJSON.titley);
		logoBl.frames = Paths.getSparrowAtlas('fnf_elemntal_logoG');
        logoBl.antialiasing = ClientPrefs.globalAntialiasing;
        logoBl.animation.addByPrefix('bump', 'fnf_element_bumbingEdit', 27, false);
        logoBl.animation.play('bump');
        logoBl.updateHitbox();
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('windows_logo'));
		add(ngSpr);
		ngSpr.visible = false;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['TheGameYT', 'him', 'Z0r0live']);
					#end
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Inspection'); // credTextShit.text += '\nFunkin';
