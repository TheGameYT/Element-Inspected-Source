...
local pref = {
	...
	Font = 'LilitaOne-Regular.ttf',        --Font that the HUD will use (default is vcr.ttf)
	TimeTxtFont = 'LilitaOne-Regular.ttf',    --Font for TimeBar
	ScoreX = 400,                  --X For ScoreTxt
	ScoreY = 675,                  --Y For ScoreTxt
	ScoreSize = 15,
	AccX = 585,                    --X For AccTxt
	AccY = 675,                    --Y For AccTxt
	AccSize = 15,
	MissX = 810,                   --X For MissTxt
	MissY = 675,                   --Y For MissTxt
	MissSize = 15,
	ShowWatermark = true,          --Shows a watermark that you can customize :)
	WatermarkTxt = 'Element Inspected (DEMO)', --Custom Watermark?!!
